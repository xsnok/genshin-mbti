...
const results = {
  ...
  ADPC: "Aggressive Dungeon Planned Canonist - You carefully plan your attacks and combos in dungeons, always following canon strategy guides.",
  ADPN: "Aggressive Dungeon Planned Non-Canon - You meticulously plan your dungeon runs but add your own twist and flair.",
  ...
  AEPC: "Aggressive Explorer Planned Canonist - You chart your exploration route carefully, following lore-based priorities for the best gains.",
  AEPN: "Aggressive Explorer Planned Non-Canon - You plan your travels but like to throw in surprises and personal tweaks along the way.",
  SDFC: "Strategic Dungeon Freeform Canonist - You enter domains with precision, adapting on the fly while honoring official strategies.",
  SDFN: "Strategic Dungeon Freeform Non-Canon - You strategize in dungeons but love experimenting with unconventional approaches.",
  SDPC: "Strategic Dungeon Planned Canonist - You calculate every move in domains according to canon-approved strategies.",
  SDPN: "Strategic Dungeon Planned Non-Canon - You make careful plans but enjoy bending the rules and trying crazy combos.",
  ...
  SEPC: "Strategic Explorer Planned Canonist - You plan every step of your exploration with canon strategies in mind.",
